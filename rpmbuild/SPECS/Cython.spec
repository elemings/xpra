...
Patch0:		Cython-0.29.2.fips-md5-sha256.patch
...
%changelog
* Fri Feb 14 2020 Eric Lemings <eric.lemings@ngc.com> - 0.29.13-3
- Update spec file to build on el8.

* Thu Jan 23 2020 Eric Lemings <eric.lemings@ngc.com> - 0.29.13-2
- Add md5/sha256 patch for FIPS-enabled systems.
