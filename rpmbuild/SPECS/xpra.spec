...
%define CFLAGS -O2
%define DEFAULT_BUILD_ARGS --with-Xdummy --without-enc_x265 --pkg-config-path=%{_libdir}/xpra/pkgconfig${PKG_CONFIG_PATH:+:${PKG_CONFIG_PATH}} --rpath=%{_libdir}/xpra --without-cuda_rebuild
...
%attr(0775,root,xpra) %{_rundir}/xpra
...
- allow user-defined PKG_CONFIG_PATH in build command
